    ...
    <section className="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex flex-row gap-y-16">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <p className="text-base leading-relaxed text-gray-600 mt-7">
              <b>Malos Technologies</b> is a leading provider of innovative web
              and software solutions, dedicated to helping businesses thrive in
              the digital age.
            </p>

            <div className="flex flex-col md:items-center md:jutify-between gap-5 mt-5">
        ...
        <p className="text-sm text-center text-gray-600">
          &copy; 2025 Malos Technologies. All rights reserved.
        </p>
      </div>
    </section>
  );
