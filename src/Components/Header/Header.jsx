      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <nav className="relative flex w-full justify-between h-16 bg-white lg:rounded-md lg:shadow-lg lg:h-24 lg:px-8 lg:py-6">
          <div className="flex flex-row items-start md:items-center flex-shrink-0">
            ...
            <Link
              to={'/'}
              className='flex flex-row items-center mt-5 md:mt-0'>
              <img className="w-auto h-8 lg:h-10" src={MalosTechnologiesLogo} alt="Malos" />
              <p className='text-xl md:text-xl lg:text-2xl font-bold'>MALOS TECHNOLOGIES</p>
            </Link>

            <button type="button" onClick={handleHeader} className="place-self-center bg-gray-200 h-fit inline-flex p-1 ml-5 text-black rounded-md lg:hidden focus:bg-gray-100 hover:bg-gray-100">
              {!showHeader ? 
